--[[ 
    ...
    Version: 5.0 (Auto-Config Based on V4.4)

    Fitur: 

    - [AUTO] Otomatis filter 25k ke atas (Tanpa Input Box)

    - [FIX] Matematika Presisi (Bisa baca "1 in 500k")

    - Anti-Stacking & Anti-Duplicate

    - UI Clean (Tanpa Kotak Setting)
...
getgenv().KenzoConfig = {
    ...
    Threshold = 25000 -- Settingan Mati di 25 Ribu (25k)
...
local function parseValue(str)
    ...
    -- Logika Potong: Ambil angka SETELAH kata "in"
...
MainFrame.Size = UDim2.new(0, 450, 0, 260) -- Ukuran lebih kecil karena input box hilang
...
-- FITUR 2: TEST BUTTON (Posisi dinaikkan karena Input Box hilang)
...
game.StarterGui:SetCore("SendNotification", {Title="Kenzo HUB V5.0", Text="Auto-Config (25k+) Ready!", Duration=5})
